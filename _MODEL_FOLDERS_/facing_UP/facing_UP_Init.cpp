...
*/                   
      //-----------------------------------------------------------------------------------------------------------------                      
      "    	highp vec3 n = normalize(mvMatrix * vec4(normal, 0.0)).xyz;                                                           \n"
      "    	highp vec3 t = normalize(mvMatrix * vec4(tangent, 0.0)).xyz;                                                          \n" 
...
//      "            vec2 tTexCoord = varTexcoord + (height * tEyeDir.xy);                                                                      \n" 
    ...
    "   highp vec3  normEYE_DIR = normalize(EyeDir) * shininess;   \n"
    
     "     highp float fDepth = texture2D(HeightMap, varTexcoord).x;                                                                               \n" 
      "     highp vec2 tTexCoord = varTexcoord + (fDepth * normEYE_DIR.xy) ;                                                                             \n" 
